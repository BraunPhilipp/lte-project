...
bs(1) = base_station(1, [100 100], 61, 8, 2000000000, 1400000, 8, randi([8,16]));
bs(2) = base_station(2, [200 100], 61, 8, 2000000000, 1400000, 8, randi([8,16]));
bs(3) = base_station(3, [200 200], 61, 8, 2000000000, 1400000, 8, randi([8,16]));
bs(4) = base_station(4, [100 200], 61, 8, 2000000000, 1400000, 8, randi([8,16]));
